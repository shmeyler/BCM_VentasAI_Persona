                ...
                <div className="flex items-center">
                  <div className="flex-shrink-0 flex items-center">
                    ...
                    <div className="border-l-2 border-gray-300 pl-4">
                      <h1 className="text-2xl font-bold text-gray-900 font-montserrat">VentasAI</h1>
                      <p className="text-sm text-orange-600 font-medium font-montserrat">Persona Generator</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center space-x-8">
                  <a href="/" className="text-gray-700 hover:text-orange-600 font-medium font-montserrat transition-colors duration-200 px-3 py-2 rounded-md hover:bg-orange-50">
                    Create Persona
                  </a>
                  <a href="/saved-personas" className="text-gray-700 hover:text-orange-600 font-medium font-montserrat transition-colors duration-200 px-3 py-2 rounded-md hover:bg-orange-50">
                    Saved Personas
                  </a>
                  <a href="/data-sources" className="text-gray-700 hover:text-orange-600 font-medium font-montserrat transition-colors duration-200 px-3 py-2 rounded-md hover:bg-orange-50">
                    Data Sources
                  </a>
                  <div className="hidden lg:block">
                    <span className="text-xs text-gray-500 font-montserrat">The AI Performance Marketing Agency</span>
                  </div>
                </div>
              </div>
            </div>
