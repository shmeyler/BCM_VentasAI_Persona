                  ...
                  <div className="flex flex-col space-y-2">
                    <div className="flex justify-between items-center">
                      <a
                        ...
                        className="bcm-nav-link text-sm font-medium flex items-center"
                      >
                    ...
                    <div className="flex justify-between items-center">
                      <a
                        ...
                        className="bcm-btn-primary text-sm py-2 px-4 flex items-center"
                      >
                        <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        onClick={() => continuePersona(generatedPersona.persona_data.id)}
                        className="text-gray-600 hover:text-gray-800 text-sm font-medium font-montserrat"
                      >
                        Edit
                      </button>
                    </div>
