                  ...
                  <div className="flex items-center justify-between mt-4">
                      <div className="flex space-x-3">
                        <a
                          ...
                          className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium font-montserrat transition-colors flex items-center"
                        >
                        ...
                        <a
                          ...
                          className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg text-sm font-medium font-montserrat transition-colors flex items-center"
                        >
                          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
